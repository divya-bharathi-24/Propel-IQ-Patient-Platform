...
namespace Propel.Api.Gateway.Migrations
{
    ...
    [Migration("20260421130000_AddRefreshTokensTable")]
            ...
            modelBuilder.Entity("Propel.Domain.Entities.Patient", b =>
                {
                    ...
                    // Note: uq_patients_email_lower (case-insensitive functional index) is managed
                    // exclusively via migrationBuilder.Sql() — not tracked here (task_003, AC-3).
