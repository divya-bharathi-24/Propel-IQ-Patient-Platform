...
```yaml
- main "360-degree patient view" [ref=e4]:
  - alert [ref=e5]:
    - generic [ref=e8]:
      - img [ref=e9]: block
      - text: Verification Blocked — 1 Unresolved Critical Conflict
    - paragraph [ref=e11]: Resolve all Critical conflicts in the sections below before verifying.
  - region "Clinical data sections"
  - button "Verify Profile" [ref=e13]:
    - generic [ref=e14]: Verify Profile
```
